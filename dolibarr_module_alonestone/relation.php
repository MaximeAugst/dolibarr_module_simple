<?php
	...
	dol_include_once('/alonestone/class/relation.class.php'); // inclus le fiche en allant le chercher dans /htdocs ou dans /custom


	$langs->load('alonestone@alonestone'); // chargement de la langue du module
...
function _card(&$object,&$relation,$mode = 'view') {
	...
	$formCore=new TFormCore('relation.php', 'formalonestone'); // et hop, voilà mon formulaire
